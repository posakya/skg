...
public class Order_detail {
    ...
    {
        return "ClassPojo [id = "+id+", updated_at = "+updated_at+", remark = "+remark+", created_at = "+created_at+", site_info = "+site_info+", updated_info = "+updated_info+", order_code = "+order_code+", order_status_name = "+order_status_name+", order_status = "+order_status+"]";
    }
}
